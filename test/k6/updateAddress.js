...
export function updateAddress() {
  group("Update Address", function () {
    let response = http.post(
      `https://${__ENV.HOSTNAME}/?wc-ajax=update_order_review`,
      {
