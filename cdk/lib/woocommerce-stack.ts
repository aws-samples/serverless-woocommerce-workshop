...
export class WooCommerceStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const wcFunction = new lambda.DockerImageFunction(this, 'woocommerce', {
      ...
      securityGroups: [wcDefaultSecurityGroup],
      filesystem: lambda.FileSystem.fromEfsAccessPoint(wcEfsAccessPoint, '/mnt/share'),
      environment: {
    ...
    const wcFUrlOriginRequestPolicy = new cloudfront.OriginRequestPolicy(this, 'wcFUrlOriginRequestPolicy', {
