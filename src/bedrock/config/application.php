...
/**
 * Setup AWS X-Ray Trace ID environment variable for each request
 */
if (isset($_SERVER['HTTP_X_AMZN_TRACE_ID'])) {
    $xray_trace_id = $_SERVER['HTTP_X_AMZN_TRACE_ID'];
    putenv("_X_AMZN_TRACE_ID=$xray_trace_id");
} else {
    // unset it when x-ray trace header is not presented
